...
namespace tello_joy
{
  ...
  constexpr int JOY_AXIS_RIGHT_LR = 2;      // Right stick left/right; 1.0 is left and -1.0 is right
  constexpr int JOY_AXIS_RIGHT_FB = 3;      // Right stick forward/back; 1.0 is forward and -1.0 is back
